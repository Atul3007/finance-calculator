                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <tbody>
                      ...
                      {result.rebate > 0 && (
                        <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
                          <td style={{ padding: '12px 0', color: '#6c757d' }}>
                            Rebate u/s 87A {values.regime === 'new' ? '(Income ≤ 7L)' : '(Income ≤ 5L)'}
                          </td>
                ...
                {values.income <= 700000 && values.regime === 'new' && (
                  <div style={{
                    ...
                    <p style={{ color: '#166534', fontSize: '14px', margin: 0 }}>
                      ✅ <strong>Good News!</strong> Under New Regime, income up to ₹7 lakh is tax-free due to rebate u/s 87A
                    </p>
                  </div>
                )}
              </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
                  <div>
                    ...
                    <div style={{
                      ...
                      <div style={{ marginBottom: '4px' }}>₹0 - 3L: <strong>0%</strong></div>
                      <div style={{ marginBottom: '4px' }}>₹3L - 7L: <strong>5%</strong></div>
                      <div style={{ marginBottom: '4px' }}>₹7L - 10L: <strong>10%</strong></div>
                      <div style={{ marginBottom: '4px' }}>₹10L - 12L: <strong>15%</strong></div>
                      <div style={{ marginBottom: '4px' }}>₹12L - 15L: <strong>20%</strong></div>
                      <div style={{ marginBottom: '8px' }}>Above ₹15L: <strong>30%</strong></div>
                      <div style={{ 
                        padding: '8px', 
                        background: '#dcfce7', 
                        borderRadius: '4px',
                  ...
                  <div>
                    ...
                    <div style={{
                      ...
                      <div style={{ marginBottom: '4px' }}>₹0 - 2.5L: <strong>0%</strong></div>
                      <div style={{ marginBottom: '4px' }}>₹2.5L - 5L: <strong>5%</strong></div>
                      <div style={{ marginBottom: '4px' }}>₹5L - 10L: <strong>20%</strong></div>
                      <div style={{ marginBottom: '8px' }}>Above ₹10L: <strong>30%</strong></div>
                      <div style={{ 
                        padding: '8px', 
                        background: '#fef3c7', 
                        borderRadius: '4px',
