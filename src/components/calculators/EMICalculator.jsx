            ...
            <div style={{ animation: 'fadeIn 0.5s ease-in' }}>
              ...
              <div style={{
                ...
                <ul style={{ 
                  ...
                  <li>Paying extra ₹{Math.round(result.emi * 0.1).toLocaleString()} monthly saves {' '}
                    <strong>₹{Math.round(result.totalInterest * 0.25).toLocaleString()}</strong> in interest</li>
